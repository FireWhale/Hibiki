  ...
  shared_examples "global model tests" do
    ...
    describe "Global Tests" do
      ...
      describe "Associations" do
        if [Album, Song, Source, Organization, Artist,Season,Event].include?(described_class)
          it "has the association module" do
            expect(described_class.included_modules).to include(AssociationModule)
          end
        else
          it "does not have the association module" do
            expect(described_class.included_modules).to_not include(AssociationModule)
          end
        end
      end
      ...
      describe 'Partial Dates' do
        if [Artist, Source, Organization, Album, Song, Collection, User].include?(described_class)
