module CollectionModule
  ...
  included do
    ...
    scope :collection_filter, ->(user1_id, relationship, user2_id) {from("((#{self.in_collection(user1_id, relationship).to_sql}) union (#{self.not_in_collection(user2_id).to_sql})) #{self.table_name} ")}
